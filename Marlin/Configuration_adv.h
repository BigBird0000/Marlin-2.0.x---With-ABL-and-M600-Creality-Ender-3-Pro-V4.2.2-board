...
//
  ...
  //#define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_INDEX   2   // ajs Index of a fan to repurpose as the chamber fan. (Default: first unused fan)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME          0  // (mm) ajs was 10 Extra distance to prime nozzle after returning from park.
